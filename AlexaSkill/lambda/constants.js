const strings = {
    ...
    YOUR_USERID_IS_MESSAGE: 'Tu identificador de usuario para conectarte a la aplicación móvil es ',
    ...
    ' La vida de los integrantes de la Nave de Exploración Felicity está en peligro. ',
    ...
    PREPARE_FIRST_TIME_MESSAGE: 'Prepárate. Tu aventura va a comenzar en unos segundos. <break time="1s"/>" ',
    YOUR_MISSION_IS_MESSAGE: 'Tu misión es rescatarlos: para eso tienes que entrar en la nave, ponerla en marcha y despegar para salir del planeta. ',
    GUIDE_MESSAGE:'Te recomiendo que vayas al purificador. Si no sabes qué hacer, recuerda que puedes pedirme ayuda o las instrucciones en cualquier momento. ',
